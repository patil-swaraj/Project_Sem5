 ...
 * @author SWARAJ
 */
public class DemoVideo extends javax.swing.JFrame {

    /**
     * Creates new form DemoVideo
     */
    public DemoVideo() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Recent calls");

        jLabel4.setText("No Recent Calls");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DemoVideo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
