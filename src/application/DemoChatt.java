 ...
 * @author SWARAJ
 */
public class DemoChatt extends javax.swing.JFrame {

    /**
     * Creates new form DemoChatt
     */
    public DemoChatt() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DemoChatt.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
